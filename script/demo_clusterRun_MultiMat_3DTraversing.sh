...
--run_main "multiMat3DTraversing" \
--run_directory "multiMat3DTraversing" \
--run_name "multiMat3DTraversing" \
--desired_shape "max_COM_x" \
--isFixedFromTop 0 \
--isFixedFromOneEnd 0 \
--isFloorEnabled 1 \
--fitness_calc_type "max_dist_move" \
--fitness_maximize 1 \
...
--ColBondZ 0.01 \
--SlowBondZ 0.001 \
--material_names "E30"   "N108E30"   "SS960"  "N157DS30"  \
--M_pervols      0.0     84e3        0.0      62e3      \
--densities      1.07e3  2.41e3      1.45e3   1.86e3    \
--moduli         69e3    150e3       1.93e6   710e3     \
--SMP_flag       0      0       0       0       \
--material_num 4 \
